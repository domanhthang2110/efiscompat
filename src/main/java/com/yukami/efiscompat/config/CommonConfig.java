...
@EventBusSubscriber(modid = EpicFightIronCompat.MODID, bus = EventBusSubscriber.Bus.MOD)
public class CommonConfig {
    ...
    static {
        ...
        CAST_CANCEL_COOLDOWN = BUILDER.comment("Enable or disable spell cooldown when the spell is interrupted by guarding/blocking or dodging").define("EnableSkillCooldown", true);
